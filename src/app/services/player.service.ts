...
export class PlayerService {
  ...
  createPlayer(type: string): IPlayer {
    switch (type) {
      case "Warrior":
        return new Warrior(1, "/assets/images/Yigif.gif", "Master Yi", 100, 100, 300, 30, [
      ...
      case "Mage":
        return new Mage(2, "/assets/images/ahrigif.gif", "Ahri", 100, 100, 300, 30, [
          ...
          { id: 3, name: "Charm", color: "green", cost: { name: "mana", value: 10, faIcon: "fa-solid fa-fire-alt " }, damage: 3, type: "stun", btnBootstrapColor: "btn-success", faIcon: "fa-solid fa-briefcase-medical ", spellIcon: "/assets/images/ahriicon/a.png", description: "Ahri blows a kiss in a direction, damaging and charming the first enemy it hits. The charmed target is forced to move toward Ahri." },
      ...
      case "Healer":
        return new Healer(3, "", "", 100, 100, 300, 30, [
      ...
      case "Tank":
        return new Tank(4, "/assets/images/panthgif.gif", "Pantheon", 100, 100, 300, 30, [
      ...
      case "Rogue":
        return new Rogue(5, "/assets/images/kindredgif.gif", "Kindred", 100, 100, 300, 30, [
